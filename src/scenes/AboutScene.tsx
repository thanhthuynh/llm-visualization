      ...
      <motion.div {...outerMotionProps}>
        ...
        {reduced ? (
          <div data-testid="about-body" className="mt-6 leading-[27px]">
            <p>
              Every number, embedding coordinate, attention weight, and probability shown in this
              site comes from a small open reference model &mdash; <strong>GPT-2 small</strong>, run
              offline. They are <em>illustrative</em>. Frontier providers (Claude, ChatGPT) do not
              expose token-level attention, embedding coordinates, or full next-token distributions
              for arbitrary input, so this site cannot honestly visualize their internals.
            </p>
        ...
        {reduced ? (
          ...
          <motion.div
            className="mt-12 pt-6 border-t border-border flex flex-col gap-4"
            variants={entranceItem}
          >
            <p className="font-mono text-[11px] uppercase tracking-widest text-text-muted">
              Built with
